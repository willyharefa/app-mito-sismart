        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Stock -->
                    <li class="menu-item {{ $state_menu == "inventory" ? "active open" : "" }}">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item {{ $menu_title == "Stock Master" ? "active bx-flashing" : "" }}">
                                <a href="{{ route('stocks.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">Stock Master</div>
                                </a>
                            </li>
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="javascript:void(0);" class="menu-link">
                                    <div data-i18n="Without navbar">Transfer Stock</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <!-- Partner -->
                    <li class="menu-item {{ $state_menu == "partner" ? "active open" : "" }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-folder"></i>
                            <div>Partner</div>
                        </a>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item {{ $menu_title == "Customers" ? "active bx-flashing" : "" }}">
                                <a href="{{ route('customer.index') }}" class="menu-link">
                                    <div>Customers</div>
                                </a>
                            </li>
                            <li class="menu-item {{ $menu_title == "Vendor" ? "active bx-flashing" : "" }}">
                                <a href="{{ route('vendor.index') }}" class="menu-link">
                                    <div data-i18n="Without navbar">Vendor</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    {{-- Transaction --}}
                    <li class="menu-item {{ $state_menu == "transaction" ? "active open" : "" }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div>Transaction</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item {{ $menu_title == "PO Internal" ? "active bx-flashing" : "" }}">
                                <a href="{{ route('po-internal.index') }}" class="menu-link">
                                    <div>PO Internal</div>
                                </a>
                            </li>
                            <li class="menu-item {{ $menu_title == "SPPB" ? "active bx-flashing" : "" }}">
                    ...
                    {{-- Projects --}}
                    <li class="menu-item {{ $state_menu == "projects" ? "active open" : "" }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-folder"></i>
                            <div>Projects</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item {{ $menu_title == "Menu Prospects" ? "active bx-flashing" : "" }}">
                    ...
                    {{-- Projects --}}
                    <li class="menu-item {{ $state_menu == "activity" ? "active open" : "" }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-folder"></i>
                            <div>Activity Sales</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item {{ $menu_title == "Menu Mapping" ? "active bx-flashing" : "" }}">
                                <a href="{{ route('mapping.index') }}" class="menu-link">
                                    <div>Mapping</div>
                                </a>
                            </li>
                            <li class="menu-item {{ $menu_title == "Menu Introduction" ? "active bx-flashing" : "" }}">
                                <a href="{{ route('introduction.index') }}" class="menu-link">
                                    <div>Introduction</div>
                                </a>
                            </li>
                            <li class="menu-item {{ $menu_title == "Menu Penetration" ? "active bx-flashing" : "" }}">
                                <a href="{{ route('penetration.index') }}" class="menu-link">
                                    <div>Penetration</div>
                                </a>
                            </li>
                            <li class="menu-item {{ $menu_title == "Menu Jartest" ? "active bx-flashing" : "" }}">
                                <a href="{{ route('jartest.index') }}" class="menu-link">
                                    <div>Jartest</div>
                                </a>
                            </li>
                            <li class="menu-item {{ $menu_title == "Menu Quotation" ? "active bx-flashing" : "" }}">
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                <div>Sistem Marketing <strong>PT Mito Energi Indonesia</strong></div>
                            </div>
                        </div>
                        <!-- /Search -->
                        ...
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                ...
                                <a href="https://mitoindonesia.com" target="_blank"
                                    class="footer-link fw-bolder">Mito Energi Indonesia</a>
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
