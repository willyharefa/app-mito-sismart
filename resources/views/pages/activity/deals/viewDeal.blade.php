...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Activity / Deal / </span> View</h4>
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="mb-0">Information Deals</h5> <small class="text-muted float-end">Document Deal</small>
                        </div>
                        <div class="card-body">
                                <div class="row mb-3">
