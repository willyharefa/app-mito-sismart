                ...
                <form class="row g-3 needs-validation form-create" action="{{ route('customer.store') }}" method="POST">
                    ...
                    <div class="col-md-3">
                        ...
                        @enderror" id="name_customer" name="name_customer"
                            placeholder="PT Mito Energi Indonesia" value="{{ old('name_customer') }}" required>
                    </div>
                    <div class="col-md-3">
                        <label for="stock_name" class="form-label">Type Bussiness</label>
                        <input type="text" class="form-control @error('type_bussiness')
                            is-invalid
                        @enderror" id="stock_name" name="type_bussiness" placeholder="Water Treatment" value="{{ old('type_bussiness') }}" required
                    ...
                    <div class="col-md">
                        ...
                        @enderror" id="city" name="city"
                            placeholder="Pekanbaru City" value="{{ old('city') }}" required>
                    </div>
                    <div class="col-md-3">
                        <label for="npwp" class="form-label">NPWP</label>
                        <input type="text" class="form-control @error('npwp')
                            is-invalid
                        @enderror" id="npwp" name="npwp" value="{{ old('npwp') }}" placeholder="00.000.000.0-000.000">
                    </div>
                    <div class="col-md-3">
                        <label for="contact" class="form-label">Contact</label>
                        <input type="text" class="form-control @error('contact')
                            is-invalid
                        @enderror" id="contact" name="contact" value="{{ old('contact') }}" placeholder="(+62) 822 7060 3131">
                    </div>
                    <div class="col-md-3">
                        <label for="pic_customer" class="form-label">PIC Customer</label>
                        <input type="text" class="form-control @error('pic_customer')
                            is-invalid
                        @enderror" id="pic_customer" name="pic_customer" value="{{ old('pic_customer') }}" placeholder="John"
                            required>
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('pic_status')
                            is-invalid
                        @enderror" id="pic_status" name="pic_status" value="{{ old('pic_status') }}" placeholder="Manager"
                            required>
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="email" class="form-control @error('email')
                            is-invalid
                        @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="customer@example.com"
                            required>
                    </div>
                    ...
                    <div class="col mb-3">
                        ...
                        @enderror" id="branch" name="branch" aria-label="Default select example">
                          ...
                          @foreach ($branches as $branch)
                              <option value="{{ $branch->id }}" {{ old('branch') == $branch->id ? 'selected' : '' }}>{{ $branch->name_branch }}</option>
                          @endforeach
                        </select>
                      </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('pic_sales')
                            is-invalid
                        @enderror" id="pic_sales" name="pic_sales" value="{{ old('pic_sales') }}" placeholder="Yudha"
                            required
                            data-bs-toggle="tooltip"
                            data-bs-offset="0,14"
                            data-bs-placement="top"
                    ...
                    <div class="col-md">
                        ...
                        <input type="text" class="form-control @error('address')
                            is-invalid
                        @enderror" id="address" name="address" value="{{ old('address') }}" placeholder="Jl. Riau No. 16C"
                            required>
                    </div>
                    <div class="col-md-">
                        ...
                        <textarea class="form-control @error('about_customer')
                            is-invalid
                        @enderror" name="about_customer" id="about_customer" rows="3" required placeholder="This is about customer">{{ old('about_customer') }}</textarea>
                    </div>
                    <div class="col-12">
                        ...
                        <tbody>
                            @foreach ($customers as $customer)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('customer.show', $customer->id) }}" class="btn btn-icon btn-outline-primary">
                                            <span class="tf-icons bx bx-info-circle"></span>
                                        </a>
                                        <a href="{{ route('customer.edit', $customer->id) }}" class="btn btn-icon btn-outline-primary">
                                            <span class="tf-icons bx bx-message-square-edit"></span>
                                        </a>

                                        <form action="{{ route('customer.destroy', $customer->id) }}" class="d-inline-block form-destroy" method="POST">
                                            @csrf
                                            @method('DELETE')
